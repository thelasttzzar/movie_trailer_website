...
'''All information for the movies
(Title, Storyline, Release year, Poster image, and Youtube trailer)'''

# The Matrix
the_matrix = media.Movie("The Matrix",
                         "What is the Matrix? Keanu Reeves takes pills and \
                         does Kung Fu to find out.",
                         "1999",
...
blade_runner_2049 = media.Movie("Blad Runner 2049",
                                "Ryan Gosling punches Harrison Ford and looks \
                                moody.",
                                "2017",
...
the_shining = media.Movie("The Shining",
                          "Jack Nicholson trys (and fails) to murder his \
                          family, gets cold.",
                          "1980",
...
the_fifth_element = media.Movie("The Fifth Element",
                                "Bruce Wilis in orange tank top, finds love \
                                powerful enough to save everything.",
                                "1997",
...
a_space_odyssey = media.Movie("2001: A Space Odyssey",
                              "This film totally proves Kubrick faked the \
                              moonlanding. Totally.",
                              "1968",
...
gladiator = media.Movie("Gladiator",
                        ...
                        <br><em>- Russell Crowe</em>",
                        "2000",
                        "https://upload.wikimedia.org/wikipedia/en/8/8d/Gladiator_ver1.jpg",
                        "https://www.youtube.com/watch?v=Q-b7B8tOAQU")

# An array of all selected movies
movies = [the_matrix, blade_runner_2049, the_shining, the_fifth_element,
          a_space_odyssey, gladiator]
